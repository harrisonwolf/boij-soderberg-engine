...
~/betti/code/cppCode/parse_huge_output ~/betti/code/cppCode/burnfiles/c$c/huge_output.txt ~/betti/code/cppCode/burnfiles/c$c/huge_output_parsed.txt #parse
rm ~/betti/code/cppCode/burnfiles/c$c/huge_output_unique.txt
touch ~/betti/code/cppCode/burnfiles/c$c/huge_output_unique.txt
~/betti/code/cppCode/remove_duplicates ~/betti/code/cppCode/burnfiles/c$c/huge_output_parsed.txt ~/betti/code/cppCode/burnfiles/c$c/huge_output_unique.txt
